...
message.channel.send('**لديك __15__ ثانيه لمعرفه العاصمه**').then(async msg => {
const background = await Canvas.loadImage("https://media.discordapp.net/attachments/732699537168138340/778364131525918770/Web_Photo_Editor_2.jpg");
...
ctx.fillText(item.type  , 140, 150);
...
msg.channel.send(`انتهاء الوقت ولم يقم احد بـمعرفه العاصمه`);
})})})}}