...
const type = require('../lo9s.json');
const item = type[Math.floor(Math.random() * type.length)];
let author = msg.author;
const filter = response => {
return item.answers.some(answer => answer.toLowerCase() === response.content.toLowerCase());};
msg.channel.send('**لديك 15 ثانية لحل اللغز**').then(async msg => {
const background = await Canvas.loadImage("https://media.discordapp.net/attachments/732699537168138340/782171069757915166/Web_Photo_Editor.jpg");
...
ctx.font = '20px Asta2';//'25px Cario';
